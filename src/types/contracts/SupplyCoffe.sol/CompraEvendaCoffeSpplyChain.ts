...
export interface CompraEvendaCoffeSpplyChainInterface extends utils.Interface {
  functions: {
...
export interface CompraEvendaCoffeSpplyChain extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CompraEvendaCoffeSpplyChainInterface;
